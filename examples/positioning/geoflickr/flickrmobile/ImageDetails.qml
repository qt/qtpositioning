...
Flipable {
    ...
    back: Item {
        ...
        Flickable {
            ...
            Item {
                id: imageContainer
                width: Math.max(bigImage.width * bigImage.scale,
                                flickable.width)
                height: Math.max(bigImage.height * bigImage.scale,
                                 flickable.height)
                ...
                Image {
                    ...
                    onStatusChanged: {
                        ...
                        if (status == Image.Ready && width != 0) {
                            slider.minimum = Math.min(flickable.width / width,
    ...
    transitions: Transition {
        SequentialAnimation {
            ...
            PropertyAction {
                target: bigImage
                property: "smooth"
                value: !flickable.movingVertically
            }
        }
    }
}
