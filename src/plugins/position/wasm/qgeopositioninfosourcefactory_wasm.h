...
#ifndef QGEOPOSITIONINFOSOURCEFACTORY_WASM_H
#define QGEOPOSITIONINFOSOURCEFACTORY_WASM_H

#include <QObject>
#include <QGeoPositionInfoSourceFactory>

class QGeoPositionInfoSourceFactoryWasm : public QObject, public QGeoPositionInfoSourceFactory
{
    Q_OBJECT
